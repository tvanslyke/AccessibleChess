...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_UciEngine_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject UciEngine::staticMetaObject = { {
    &ChessEngine::staticMetaObject,
    qt_meta_stringdata_UciEngine.data,
    qt_meta_data_UciEngine,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *UciEngine::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UciEngine.stringdata0))
