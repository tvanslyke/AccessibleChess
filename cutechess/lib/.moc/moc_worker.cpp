...
QT_MOC_LITERAL(3, 16, 15), // "progressChanged"
QT_MOC_LITERAL(4, 32, 5), // "value"
QT_MOC_LITERAL(5, 38, 13), // "statusChanged"
QT_MOC_LITERAL(6, 52, 13), // "statusMessage"
QT_MOC_LITERAL(7, 66, 9), // "cancelled"
QT_MOC_LITERAL(8, 76, 8), // "finished"
QT_MOC_LITERAL(9, 85, 5), // "error"
QT_MOC_LITERAL(10, 91, 6) // "cancel"

    },
    "Worker\0started\0\0progressChanged\0value\0"
    "statusChanged\0statusMessage\0cancelled\0"
    "finished\0error\0cancel"
};
...
void Worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Worker::progressChanged)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Worker::statusChanged)) {
                *result = 2;
                return;
            }
        }
